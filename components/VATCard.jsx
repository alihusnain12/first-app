...
export default function VATCard() {
  const navigation=useNavigation()
  return (
    <View style={styles.container}>
      <View style={{borderWidth:1,borderRadius:10,padding:hp(2)}}>
        <Text style={{textAlign:'center',fontWeight:'800',fontSize:19}}>$39.99 per submittion</Text>
        ...
        <Button onPress={()=>navigation.navigate("VAT")} title="Continue" containerStyle={{backgroundColor: 'rgba(39, 174, 245, 0.73)',width:wp(40),padding:hp(2)}}/>
      </View>
      {/* border */}
