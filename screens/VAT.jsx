...
export default function SelfAssessmentService() {
  ...
  return (
    <ScreenWrapper>
      <Header title="VAT Return Services" onPress={() => navigation.goBack()} />
      <View style={styles.container}>
        ...
        <Text style={styles.label}>Total Sales Amount</Text>
        <TextInput
          style={styles.input}
          value={field2}
        ...
        <Text style={styles.label}>VAT Paid On Purchases</Text>
        <TextInput
          style={styles.input}
          value={field3}
        ...
        <Text style={styles.label}>VAT Period</Text>
        <TextInput
          style={styles.input}
          value={field4}
